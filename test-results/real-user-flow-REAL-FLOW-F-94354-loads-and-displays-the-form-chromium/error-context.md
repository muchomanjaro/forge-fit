...
- Name: real-user-flow.spec.ts >> REAL FLOW: Feature Data Flow >> workout page loads and displays the form
- Location: e2e/real-user-flow.spec.ts:107:7
        ...
        - generic [ref=e26]:
          ...
          - generic [ref=e30]:
            ...
            - textbox "Email" [ref=e31]:
              ...
              - text: e2e-1780495512279@forge-fit-test.com
          - generic [ref=e32]:
            - text: Password
